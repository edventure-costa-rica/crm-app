...
},{"../../result":25,"../parser":16,"moment":29}],6:[function(require,module,exports){
...
},{"../../result":25,"../parser":16,"moment":29}],7:[function(require,module,exports){
...
},{"../../result":25,"../../utils/EN":26,"../parser":16,"moment":29}],8:[function(require,module,exports){
...
},{"../../result":25,"../../utils/EN":26,"../parser":16,"moment":29}],9:[function(require,module,exports){
...
},{"../../result":25,"../parser":16,"moment":29}],10:[function(require,module,exports){
...
},{"../../result":25,"../parser":16,"moment":29}],11:[function(require,module,exports){
...
},{"../../result":25,"../parser":16,"moment":29}],12:[function(require,module,exports){
...
},{"../../result":25,"../parser":16,"moment":29}],13:[function(require,module,exports){
...
},{"../../result":25,"../parser":16,"moment":29}],14:[function(require,module,exports){
...
},{"../../result":25,"../parser":16,"moment":29}],15:[function(require,module,exports){
...
},{"../../result":25,"../../utils/JP":27,"../parser":16,"moment":29}],16:[function(require,module,exports){
...
},{"react/lib/LinkedStateMixin":64}],31:[function(require,module,exports){
"use strict";function emptyFn(){}var React=require("react"),moment=require("moment"),assign=require("object-assign"),FORMAT=require("./utils/format"),asConfig=require("./utils/asConfig"),toMoment=require("./toMoment"),onEnter=require("./onEnter"),assign=require("object-assign"),TODAY,DecadeView=React.createClass({displayName:"DecadeView",getDefaultProps:function(){return asConfig()},getYearsInDecade:function(e){var t=moment(e).get("year"),r=t%10;t=t-r-1;for(var n=[],a=0,i=moment(t,"YYYY").startOf("year");12>a;a++)n.push(moment(i)),i.add(1,"year");return n},render:function(){TODAY=+moment().startOf("day");var e=assign({},this.props),t=e.viewMoment=moment(this.props.viewDate);e.date&&(e.moment=moment(e.date).startOf("year"));var r=this.getYearsInDecade(t);return React.createElement("div",{className:"dp-table dp-decade-view"},this.renderYears(e,r))},renderYears:function(e,t){for(var r=t.map(function(t,r,n){return this.renderYear(e,t,r,n)},this),n=t.length,a=[],i=Math.ceil(n/4),s=0;i>s;s++)a.push(r.slice(4*s,4*(s+1)));return a.map(function(e,t){return React.createElement("div",{key:"row"+t,className:"dp-row"},e)})},renderYear:function(e,t,r,n){var a=FORMAT.year(t,e.yearFormat),i=["dp-cell dp-year"],s=+t;s==e.moment&&i.push("dp-value"),r||i.push("dp-prev"),r==n.length-1&&i.push("dp-next");var o=this.handleClick.bind(this,e,t);return React.createElement("div",{role:"link",tabIndex:"1",key:a,className:i.join(" "),onClick:o,onKeyUp:onEnter(o)},a)},handleClick:function(e,t,r){r.target.value=t,(e.onSelect||emptyFn)(t,r)}});DecadeView.getHeaderText=function(e,t){var r=moment(e).get("year"),n=r%10;return r=r-n-1,r+" - "+(r+11)},module.exports=DecadeView;
},{"./onEnter":37,"./toMoment":38,"./utils/asConfig":39,"./utils/format":40,"moment":29,"object-assign":42,"react":202}],32:[function(require,module,exports){
"use strict";var React=require("react"),P=React.PropTypes,onEnter=require("./onEnter");module.exports=React.createClass({displayName:"DatePickerHeader",propTypes:{onChange:P.func,onPrev:P.func,onNext:P.func,colspan:P.number,children:P.node},render:function(){var e=this.props;return React.createElement("div",{className:"dp-header"},React.createElement("div",{className:"dp-nav-table"},React.createElement("div",{className:"dp-row"},React.createElement("div",{tabIndex:"1",role:"link",className:"dp-prev-nav dp-nav-cell dp-cell",onClick:e.onPrev,onKeyUp:onEnter(e.onPrev)},e.prevText),React.createElement("div",{tabIndex:"1",role:"link",className:"dp-nav-view dp-cell",colSpan:e.colspan,onClick:e.onChange,onKeyUp:onEnter(e.onChange)},e.children),React.createElement("div",{tabIndex:"1",role:"link",className:"dp-next-nav dp-nav-cell dp-cell",onClick:e.onNext,onKeyUp:onEnter(e.onNext)},e.nextText))))}});
},{"./onEnter":37,"react":202}],33:[function(require,module,exports){
"use strict";function emptyFn(){}Object.defineProperty(exports,"__esModule",{value:!0});var React=require("react"),moment=require("moment"),assign=require("object-assign"),FORMAT=require("./utils/format"),asConfig=require("./utils/asConfig"),onEnter=require("./onEnter"),toMoment=require("./toMoment"),TODAY,MonthView=React.createClass({displayName:"MonthView",formatAsDay:function(e,t){return e.format(t||"D")},getDefaultProps:function(){return asConfig()},getWeekStartMoment:function(e){var t=this.weekStartDay,a=this.toMoment(e).day(t);return a},getDaysInMonth:function(e){var t=this.toMoment(e).startOf("month"),a=this.toMoment(e).startOf("month").add(-1,"days"),n=this.getWeekStartMoment(t),r=[],o=0;for(!a.isBefore(n)||!this.props.alwaysShowPrevWeek&&n.isSame(t)||n.add(-1,"weeks");42>o;o++)r.push(this.toMoment(n)),n.add(1,"days");return r},render:function(){var e=assign({},this.props);this.toMoment=function(t,a){return toMoment(t,a||e.dateFormat,{locale:e.locale})},TODAY=+this.toMoment().startOf("day");var t=e.dateFormat,a=e.viewMoment=this.toMoment(e.viewDate,t),n=e.weekStartDay;null==n&&(n=e.localeData._week?e.localeData._week.dow:null),this.weekStartDay=e.weekStartDay=n,e.minDate&&moment.isMoment(e.minDate)&&e.minDate.startOf("day"),e.minDate&&(e.minDate=+this.toMoment(e.minDate,t)),e.maxDate&&(e.maxDate=+this.toMoment(e.maxDate,t)),this.monthFirst=this.toMoment(a).startOf("month"),this.monthLast=this.toMoment(a).endOf("month"),e.date&&(e.moment=this.toMoment(e.date).startOf("day"));var r=this.getDaysInMonth(a);return React.createElement("div",{className:"dp-table dp-month-view"},this.renderWeekDayNames(),this.renderDays(e,r))},renderWeekNumber:function e(t,a){var n,r=a[0],o=r.weeks(),s={key:"week",className:"dp-cell dp-weeknumber",week:o,days:a,date:r,children:o},e=t.renderWeekNumber;return e&&(n=e(s)),void 0===n&&(n=React.createElement("div",s)),n},renderDays:function(e,t){for(var a,n,r=t.map(function(t){return this.renderDay(e,t)},this),o=t.length,s=[],i=Math.ceil(o/7),m=0;i>m;m++)a=7*m,n=7*(m+1),s.push([e.weekNumbers&&this.renderWeekNumber(e,t.slice(a,n))].concat(r.slice(a,n)));return s.map(function(e,t){return React.createElement("div",{key:"row"+t,className:"dp-week dp-row"},e)})},renderDay:function(e,t){var a=FORMAT.day(t,e.dayFormat),n=["dp-cell dp-day"],r=+t;r==TODAY?n.push("dp-current"):r<this.monthFirst?n.push("dp-prev"):r>this.monthLast&&n.push("dp-next");var o;e.minDate&&t<e.minDate&&(n.push("dp-disabled dp-before-min"),o=!0);var s;e.maxDate&&t>e.maxDate&&(n.push("dp-disabled dp-after-max"),s=!0),r==e.moment&&n.push("dp-value");var i=this.toMoment(t),m=this.handleClick.bind(this,e,t,r),d=i.day();(0===d||6===d)&&(n.push("dp-weekend"),e.highlightWeekends&&n.push("dp-weekend-highlight"));var h={role:"link",tabIndex:1,key:a,text:a,date:i,moment:i,className:n.join(" "),style:{},onClick:m,onKeyUp:onEnter(m),children:a};o&&(h.isDisabled=!0,h.beforeMinDate=!0),s&&(h.isDisabled=!0,h.afterMaxDate=!0),"function"==typeof e.onRenderDay&&(h=e.onRenderDay(h));var u=React.DOM.div,l=e.renderDay||u,c=l(h);return void 0===c&&(c=u(h)),c},getWeekDayNames:function(e){e=e||this.props;var t=e.weekDayNames,a=this.weekStartDay;if("function"==typeof t)t=t(a,e.locale);else if(Array.isArray(t)){t=[].concat(t);for(var n=a;n>0;)t.push(t.shift()),n--}return t},renderWeekDayNames:function(){var e=this.props.weekNumbers?[this.props.weekNumberName]:[],t=e.concat(this.getWeekDayNames());return React.createElement("div",{className:"dp-row dp-week-day-names"},t.map(function(e,t){return React.createElement("div",{key:t,className:"dp-cell dp-week-day-name"},e)}))},handleClick:function(e,t,a,n){e.minDate&&a<e.minDate||e.maxDate&&a>e.maxDate||(n.target.value=t,(e.onChange||emptyFn)(t,n))}});MonthView.getHeaderText=function(e,t){return toMoment(e,null,{locale:t.locale}).format("MMMM YYYY")},exports["default"]=MonthView,module.exports=exports["default"];
},{"./onEnter":37,"./toMoment":38,"./utils/asConfig":39,"./utils/format":40,"moment":29,"object-assign":42,"react":202}],34:[function(require,module,exports){
"use strict";function emptyFn(){}var React=require("react"),moment=require("moment"),FORMAT=require("./utils/format"),asConfig=require("./utils/asConfig"),toMoment=require("./toMoment"),onEnter=require("./onEnter"),assign=require("object-assign"),TODAY,YearView=React.createClass({displayName:"YearView",getDefaultProps:function(){return asConfig()},getMonthsInYear:function(e){for(var t=moment(e).startOf("year"),n=[],r=0;12>r;r++)n.push(moment(t)),t.add(1,"month");return n},render:function(){TODAY=+moment().startOf("day");var e=assign({},this.props),t=e.viewMoment=moment(this.props.viewDate);e.date&&(e.moment=moment(e.date).startOf("month"));var n=this.getMonthsInYear(t);return React.createElement("div",{className:"dp-table dp-year-view"},this.renderMonths(e,n))},renderMonths:function(e,t){for(var n=t.map(function(t){return this.renderMonth(e,t)},this),r=t.length,a=[],o=Math.ceil(r/4),i=0;o>i;i++)a.push(n.slice(4*i,4*(i+1)));return a.map(function(e,t){return React.createElement("div",{key:"row"+t,className:"dp-row"},e)})},renderMonth:function(e,t){var n=FORMAT.month(t,e.monthFormat),r=["dp-cell dp-month"],a=+t;a==e.moment&&r.push("dp-value");var o=this.handleClick.bind(this,e,t);return React.createElement("div",{tabIndex:"1",role:"link",key:n,className:r.join(" "),onClick:o,onKeyUp:onEnter(o)},n)},handleClick:function(e,t,n){n.target.value=t,(e.onSelect||emptyFn)(t,n)}});YearView.getHeaderText=function(e,t){return toMoment(e,null,{locale:t.locale}).format("YYYY")},module.exports=YearView;
},{"./onEnter":37,"./toMoment":38,"./utils/asConfig":39,"./utils/format":40,"moment":29,"object-assign":42,"react":202}],35:[function(require,module,exports){
"use strict";var getWeekDayNames=require("./utils/getWeekDayNames");module.exports={weekDayNames:getWeekDayNames,weekStartDay:null,locale:null,dayFormat:"D",monthFormat:"MMMM",yearFormat:"YYYY",navPrev:"‹",navNext:"›",view:null,date:null,minDate:null,maxDate:null,viewDate:null,dateFormat:"YYYY-MM-DD",onRenderDay:null,renderDay:null,alwaysShowPrevWeek:!1};
},{"./utils/getWeekDayNames":41}],36:[function(require,module,exports){
"use strict";function emptyFn(){}var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var o in a)Object.prototype.hasOwnProperty.call(a,o)&&(e[o]=a[o])}return e},React=require("react"),moment=require("moment"),assign=require("object-assign"),asConfig=require("./utils/asConfig"),MonthView=require("./MonthView"),YearView=require("./YearView"),DecadeView=require("./DecadeView"),Header=require("./Header"),toMoment=require("./toMoment"),hasOwn=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},onEnter=require("./onEnter"),Views={month:MonthView,year:YearView,decade:DecadeView},DatePicker=React.createClass({displayName:"DatePicker",propTypes:{todayText:React.PropTypes.string,gotoSelectedText:React.PropTypes.string,renderFooter:React.PropTypes.func,onChange:React.PropTypes.func,date:React.PropTypes.any,viewDate:React.PropTypes.any},getViewOrder:function(){return this.props.viewOrder||["month","year","decade"]},getDefaultProps:function(){var e=assign({},asConfig(),{highlightWeekends:!1,weekNumberName:"",isDatePicker:!0,navOnDateClick:!0,defaultStyle:{boxSizing:"border-box"}});return delete e.viewDate,delete e.date,e},getInitialState:function(){return{view:this.props.defaultView,viewDate:this.props.defaultViewDate,defaultDate:this.props.defaultDate}},getViewName:function(){var e=null!=this.props.view?this.props.view:this.state.view;return e||"month"},addViewIndex:function(e){var t=this.getViewName(),a=this.getViewOrder(),o=a.indexOf(t);return o+=e,o%a.length},getNextViewName:function(){return this.getViewOrder()[this.addViewIndex(1)]},getPrevViewName:function(){return this.getViewOrder()[this.addViewIndex(-1)]},getView:function(){var e=this.props.views||Views;return e[this.getViewName()]||e.month},getViewFactory:function(){var e=this.getView();return React.createFactory&&e&&e.prototype&&"function"==typeof e.prototype.render&&(e.__factory=e.__factory||React.createFactory(e),e=e.__factory),e},getViewDate:function(){var e=hasOwn(this.props,"viewDate")?this.props.viewDate:this.state.viewDate;return e=e||this.viewMoment||this.getDate()||new Date,moment.isMoment(e)&&(e=+e),e=this.toMoment(e)},getDate:function(){var e;return e=hasOwn(this.props,"date")?this.props.date:this.state.defaultDate,e?this.toMoment(e):null},render:function(){var e=assign({},this.props);this.toMoment=function(t,a){return toMoment(t,a||e.dateFormat,{locale:e.locale})};var t=this.getViewFactory();e.date=this.getDate();var a=null==e.date?"":e.date.format(this.props.dateFormat);e.viewDate=this.viewMoment=this.getViewDate(),e.locale=this.props.locale,e.localeData=moment.localeData(e.locale),e.renderDay=this.props.renderDay,e.onRenderDay=this.props.onRenderDay;var o=(this.props.className||"")+" date-picker";e.style=this.prepareStyle(e);var i=e,i=asConfig(e);return i.highlightWeekends=this.props.highlightWeekends,i.weekNumbers=this.props.weekNumbers,i.weekNumberName=this.props.weekNumberName,i.dateString=a,i.localeData=e.localeData,i.onSelect=this.handleSelect,i.onChange=this.handleChange,i.onWeekChange=this.props.onWeekChange,i.renderWeekNumber=this.props.renderWeekNumber,React.createElement("div",_extends({},this.props,{className:o,style:e.style}),this.renderHeader(t,e),React.createElement("div",{className:"dp-body",style:{flex:1}},t(i)),this.renderFooter(e))},prepareStyle:function(e){return assign({},e.defaultStyle,e.style)},renderFooter:function(e){if(!this.props.hideFooter){this.props.today&&console.warn('Please use "todayText" prop instead of "today"!'),this.props.gotoSelected&&console.warn('Please use "gotoSelectedText" prop instead of "gotoSelected"!');var t,a=this.props.todayText||"Today",o=this.props.gotoSelectedText||"Go to selected",i={todayText:a,gotoSelectedText:o,gotoToday:this.gotoNow,gotoSelected:this.gotoSelected.bind(this,e),date:e.date,viewDate:e.viewDate};return"function"==typeof this.props.footerFactory&&(t=this.props.footerFactory(i)),void 0!==t?t:React.createElement("div",{className:"dp-footer"},React.createElement("div",{tabIndex:"1",role:"link",className:"dp-footer-today",onClick:i.gotoToday,onKeyUp:onEnter(i.gotoToday)},a),React.createElement("div",{tabIndex:"1",role:"link",className:"dp-footer-selected",onClick:i.gotoSelected,onKeyUp:onEnter(i.gotoSelected)},o))}},gotoNow:function(){this.gotoDate(+new Date)},gotoSelected:function(e){this.gotoDate(e.date||+new Date)},gotoDate:function(e){this.setView("month"),this.setViewDate(e)},getViewColspan:function(){var e={month:5,year:2,decade:2};return e[this.getViewName()]},renderHeader:function(e,t){if(!this.props.hideHeader){t=t||this.props;var a=this.getViewDate(),o=this.getView().getHeaderText(a,t),i=this.getViewColspan(),n=this.props.navPrev,r=this.props.navNext;return React.createElement(Header,{prevText:n,nextText:r,colspan:i,onPrev:this.handleNavPrev,onNext:this.handleNavNext,onChange:this.handleViewChange},o)}},handleRenderDay:function(e){return(this.props.renderDay||emptyFn)(e)||[]},handleViewChange:function(){this.setView(this.getNextViewName())},setView:function(e){"function"==typeof this.props.onViewChange&&this.props.onViewChange(e),null==this.props.view&&this.setState({view:e})},setViewDate:function(e){e=this.toMoment(e);var t=this.props.onViewDateChange;if("function"==typeof t){var a=e.format(this.props.dateFormat),o=this.getViewName();t(a,e,o)}hasOwn(this.props,"viewDate")||this.setState({viewDate:e})},getNext:function(){var e=this.getViewDate(),t=this.toMoment;return{month:function(){return t(e).add(1,"month")},year:function(){return t(e).add(1,"year")},decade:function(){return t(e).add(10,"year")}}[this.getViewName()]()},getPrev:function(){var e=this.getViewDate(),t=this.toMoment;return{month:function(){return t(e).add(-1,"month")},year:function(){return t(e).add(-1,"year")},decade:function(){return t(e).add(-10,"year")}}[this.getViewName()]()},handleNavigation:function(e,t){var a=-1==e?this.getPrev():this.getNext();if(this.setViewDate(a),"function"==typeof this.props.onNav){var o=a.format(this.props.dateFormat),i=this.getViewName();this.props.onNav(o,a,i,e,t)}},handleNavPrev:function(e){this.handleNavigation(-1,e)},handleNavNext:function(e){this.handleNavigation(1,e)},handleChange:function(e,t){if(e=this.toMoment(e),this.props.navOnDateClick){var a=this.toMoment(this.getViewDate()),o=a.format("YYYY-MM"),i=e.format("YYYY-MM");i>o?this.handleNavNext(t):o>i&&this.handleNavPrev(t)}var n=e.format(this.props.dateFormat);hasOwn(this.props,"date")||this.setState({defaultDate:n}),(this.props.onChange||emptyFn)(n,e,t)},handleSelect:function(e,t){var a=this.getViewName(),o={decade:"year",year:"month"}[a],i=e.get(o),n=this.toMoment(this.getViewDate()).set(o,i),r=this.getPrevViewName();if(this.setViewDate(n),this.setView(r),"function"==typeof this.props.onSelect){var s=n.format(this.props.dateFormat);this.props.onSelect(s,n,r,t)}}});DatePicker.views=Views;var PT=React.PropTypes;DatePicker.propTypes={highlightWeekends:PT.bool,onChange:PT.func,onNav:PT.func,onSelect:PT.func,renderDay:PT.func,onRenderDay:PT.func,defaultView:PT.string,view:PT.string,onViewDateChange:PT.func,onViewChange:PT.func,navOnDateClick:PT.bool},module.exports=DatePicker;
},{"./DecadeView":31,"./Header":32,"./MonthView":33,"./YearView":34,"./onEnter":37,"./toMoment":38,"./utils/asConfig":39,"moment":29,"object-assign":42,"react":202}],37:[function(require,module,exports){
"use strict";module.exports=function(t){return function(e){"Enter"==e.key&&t(e)}};
},{}],38:[function(require,module,exports){
"use strict";var moment=require("moment"),CONFIG=require("./config");module.exports=function(e,t,r){var o=!(!r||!r.strict),n=r&&r.locale;return t=t||CONFIG.dateFormat,"string"==typeof e?moment(e,t,n,o):moment(null==e?new Date:e,void 0,n,o)};
},{"./config":35,"moment":29}],39:[function(require,module,exports){
"use strict";function copyList(s,e,i){return s&&i.forEach(function(i){e[i]=s[i]}),e}var assign=require("object-assign"),CONFIG=require("../config"),KEYS=Object.keys(CONFIG);module.exports=function(s,e){var i=KEYS;return e&&(i=Object.keys(e)),e=e||CONFIG,s?copyList(s,assign({},e),i):assign({},e)};
},{"../config":35,"object-assign":42}],40:[function(require,module,exports){
"use strict";function f(t,r){return toMoment(t).format(r)}var CONFIG=require("../config"),toMoment=require("../toMoment");module.exports={day:function(t,r){return f(t,r||CONFIG.dayFormat)},month:function(t,r){return f(t,r||CONFIG.monthFormat)},year:function(t,r){return f(t,r||CONFIG.yearFormat)}};
},{"../config":35,"../toMoment":38}],41:[function(require,module,exports){
"use strict";var moment=require("moment"),DEFAULT_WEEK_START_DAY=1*moment().startOf("week").format("d");module.exports=function(e,t){var r;if(t){var o=moment.localeData(t);r=o&&o._weekdaysShort?o._weekdaysShort:r}r=(r||moment.weekdaysShort()).concat();for(var a=r,m=null==e?DEFAULT_WEEK_START_DAY:e;m>0;)a.push(a.shift()),m--;return a};
},{"moment":29}],42:[function(require,module,exports){
...
},{"./CSSProperty":46,"./ReactPerf":116,"./dangerousStyleValue":151,"_process":1,"fbjs/lib/ExecutionEnvironment":176,"fbjs/lib/camelizeStyleName":178,"fbjs/lib/hyphenateStyleName":189,"fbjs/lib/memoizeStringOnly":196,"fbjs/lib/warning":201}],48:[function(require,module,exports){
(function (process){
...
},{"./Object.assign":66,"./PooledClass":67,"_process":1,"fbjs/lib/invariant":190}],49:[function(require,module,exports){
...
},{"./Danger":54,"./ReactMultiChildUpdateTypes":112,"./ReactPerf":116,"./setInnerHTML":170,"./setTextContent":171,"_process":1,"fbjs/lib/invariant":190}],52:[function(require,module,exports){
(function (process){
...
},{"_process":1,"fbjs/lib/invariant":190}],53:[function(require,module,exports){
(function (process){
...
},{"./DOMProperty":52,"./ReactPerf":116,"./quoteAttributeValueForBrowser":168,"_process":1,"fbjs/lib/warning":201}],54:[function(require,module,exports){
(function (process){
...
},{"_process":1,"fbjs/lib/ExecutionEnvironment":176,"fbjs/lib/createNodesFromMarkup":181,"fbjs/lib/emptyFunction":182,"fbjs/lib/getMarkupWrap":186,"fbjs/lib/invariant":190}],55:[function(require,module,exports){
...
},{"./EventPluginRegistry":59,"./EventPluginUtils":60,"./ReactErrorUtils":100,"./accumulateInto":148,"./forEachAccumulated":156,"_process":1,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],59:[function(require,module,exports){
(function (process){
...
},{"_process":1,"fbjs/lib/invariant":190}],60:[function(require,module,exports){
(function (process){
...
},{"./EventConstants":57,"./ReactErrorUtils":100,"_process":1,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],61:[function(require,module,exports){
(function (process){
...
},{"./EventConstants":57,"./EventPluginHub":58,"./accumulateInto":148,"./forEachAccumulated":156,"_process":1,"fbjs/lib/warning":201}],62:[function(require,module,exports){
...
},{"./ReactPropTypeLocations":118,"./ReactPropTypes":119,"_process":1,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],66:[function(require,module,exports){
...
},{"_process":1,"fbjs/lib/invariant":190}],68:[function(require,module,exports){
...
},{"./ReactInstanceMap":106,"./findDOMNode":154,"_process":1,"fbjs/lib/warning":201}],70:[function(require,module,exports){
...
},{"./ReactReconciler":121,"./instantiateReactComponent":164,"./shouldUpdateReactComponent":172,"./traverseAllChildren":173,"_process":1,"fbjs/lib/warning":201}],72:[function(require,module,exports){
...
},{"./Object.assign":66,"./ReactComponent":74,"./ReactElement":96,"./ReactNoopUpdateQueue":114,"./ReactPropTypeLocationNames":117,"./ReactPropTypeLocations":118,"_process":1,"fbjs/lib/emptyObject":183,"fbjs/lib/invariant":190,"fbjs/lib/keyMirror":193,"fbjs/lib/keyOf":194,"fbjs/lib/warning":201}],74:[function(require,module,exports){
(function (process){
...
},{"./ReactNoopUpdateQueue":114,"./canDefineProperty":150,"_process":1,"fbjs/lib/emptyObject":183,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],75:[function(require,module,exports){
...
},{"_process":1,"fbjs/lib/invariant":190}],77:[function(require,module,exports){
(function (process){
...
},{"./Object.assign":66,"./ReactComponentEnvironment":76,"./ReactCurrentOwner":78,"./ReactElement":96,"./ReactInstanceMap":106,"./ReactPerf":116,"./ReactPropTypeLocationNames":117,"./ReactPropTypeLocations":118,"./ReactReconciler":121,"./ReactUpdateQueue":128,"./shouldUpdateReactComponent":172,"_process":1,"fbjs/lib/emptyObject":183,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],78:[function(require,module,exports){
...
},{"./ReactElement":96,"./ReactElementValidator":97,"_process":1,"fbjs/lib/mapObject":195}],83:[function(require,module,exports){
...
},{"./DOMChildrenOperations":51,"./DOMPropertyOperations":53,"./ReactMount":110,"./ReactPerf":116,"_process":1,"fbjs/lib/invariant":190}],85:[function(require,module,exports){
(function (process){
...
},{"./LinkedValueUtils":65,"./Object.assign":66,"./ReactDOMIDOperations":84,"./ReactMount":110,"./ReactUpdates":129,"_process":1,"fbjs/lib/invariant":190}],86:[function(require,module,exports){
(function (process){
...
},{"./Object.assign":66,"./ReactChildren":72,"./ReactDOMSelect":87,"_process":1,"fbjs/lib/warning":201}],87:[function(require,module,exports){
(function (process){
...
},{"./LinkedValueUtils":65,"./Object.assign":66,"./ReactMount":110,"./ReactUpdates":129,"_process":1,"fbjs/lib/warning":201}],88:[function(require,module,exports){
...
},{"./DOMChildrenOperations":51,"./DOMPropertyOperations":53,"./Object.assign":66,"./ReactComponentBrowserEnvironment":75,"./ReactMount":110,"./escapeTextContentForBrowser":153,"./setTextContent":171,"./validateDOMNesting":174,"_process":1}],91:[function(require,module,exports){
(function (process){
...
},{"./LinkedValueUtils":65,"./Object.assign":66,"./ReactDOMIDOperations":84,"./ReactUpdates":129,"_process":1,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],92:[function(require,module,exports){
...
},{"./BeforeInputEventPlugin":45,"./ChangeEventPlugin":49,"./ClientReactRootIndex":50,"./DefaultEventPluginOrder":55,"./EnterLeaveEventPlugin":56,"./HTMLDOMPropertyConfig":63,"./ReactBrowserComponentMixin":69,"./ReactComponentBrowserEnvironment":75,"./ReactDOMComponent":81,"./ReactDOMTextComponent":90,"./ReactDefaultBatchingStrategy":92,"./ReactDefaultPerf":94,"./ReactEventListener":102,"./ReactInjection":103,"./ReactInstanceHandles":105,"./ReactMount":110,"./ReactReconcileTransaction":120,"./SVGDOMPropertyConfig":131,"./SelectEventPlugin":132,"./ServerReactRootIndex":133,"./SimpleEventPlugin":134,"_process":1,"fbjs/lib/ExecutionEnvironment":176}],94:[function(require,module,exports){
...
},{"./Object.assign":66,"./ReactCurrentOwner":78,"./canDefineProperty":150,"_process":1}],97:[function(require,module,exports){
(function (process){
...
},{"./ReactCurrentOwner":78,"./ReactElement":96,"./ReactPropTypeLocationNames":117,"./ReactPropTypeLocations":118,"./canDefineProperty":150,"./getIteratorFn":161,"_process":1,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],98:[function(require,module,exports){
...
},{"./ReactRootIndex":123,"_process":1,"fbjs/lib/invariant":190}],106:[function(require,module,exports){
...
},{"./Object.assign":66,"./ReactChildren":72,"./ReactClass":73,"./ReactComponent":74,"./ReactDOMFactories":82,"./ReactElement":96,"./ReactElementValidator":97,"./ReactPropTypes":119,"./ReactVersion":130,"./onlyChild":167,"_process":1}],108:[function(require,module,exports){
...
},{"./DOMProperty":52,"./Object.assign":66,"./ReactBrowserEventEmitter":70,"./ReactCurrentOwner":78,"./ReactDOMFeatureFlags":83,"./ReactElement":96,"./ReactEmptyComponentRegistry":99,"./ReactInstanceHandles":105,"./ReactInstanceMap":106,"./ReactMarkupChecksum":109,"./ReactPerf":116,"./ReactReconciler":121,"./ReactUpdateQueue":128,"./ReactUpdates":129,"./instantiateReactComponent":164,"./setInnerHTML":170,"./shouldUpdateReactComponent":172,"./validateDOMNesting":174,"_process":1,"fbjs/lib/containsNode":179,"fbjs/lib/emptyObject":183,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],111:[function(require,module,exports){
(function (process){
...
},{"./ReactChildReconciler":71,"./ReactComponentEnvironment":76,"./ReactCurrentOwner":78,"./ReactMultiChildUpdateTypes":112,"./ReactReconciler":121,"./flattenChildren":155,"_process":1}],112:[function(require,module,exports){
...
},{"./Object.assign":66,"_process":1,"fbjs/lib/invariant":190}],114:[function(require,module,exports){
(function (process){
...
},{"_process":1,"fbjs/lib/warning":201}],115:[function(require,module,exports){
(function (process){
...
},{"_process":1,"fbjs/lib/invariant":190}],116:[function(require,module,exports){
(function (process){
...
},{"./ReactDefaultBatchingStrategy":92,"./ReactElement":96,"./ReactInstanceHandles":105,"./ReactMarkupChecksum":109,"./ReactServerBatchingStrategy":124,"./ReactServerRenderingTransaction":126,"./ReactUpdates":129,"./instantiateReactComponent":164,"_process":1,"fbjs/lib/emptyObject":183,"fbjs/lib/invariant":190}],126:[function(require,module,exports){
...
},{"./Object.assign":66,"./ReactCurrentOwner":78,"./ReactElement":96,"./ReactInstanceMap":106,"./ReactUpdates":129,"_process":1,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],129:[function(require,module,exports){
(function (process){
...
},{"./CallbackQueue":48,"./Object.assign":66,"./PooledClass":67,"./ReactPerf":116,"./ReactReconciler":121,"./Transaction":146,"_process":1,"fbjs/lib/invariant":190}],130:[function(require,module,exports){
...
},{"./Object.assign":66,"./PooledClass":67,"_process":1,"fbjs/lib/emptyFunction":182,"fbjs/lib/warning":201}],139:[function(require,module,exports){
...
},{"_process":1,"fbjs/lib/invariant":190}],147:[function(require,module,exports){
...
},{"_process":1,"fbjs/lib/invariant":190}],149:[function(require,module,exports){
...
},{"./Object.assign":66,"_process":1,"fbjs/lib/warning":201}],153:[function(require,module,exports){
...
},{"./ReactCurrentOwner":78,"./ReactInstanceMap":106,"./ReactMount":110,"_process":1,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],155:[function(require,module,exports){
(function (process){
...
},{"./Object.assign":66,"./ReactCompositeComponent":77,"./ReactEmptyComponent":98,"./ReactNativeComponent":113,"_process":1,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],165:[function(require,module,exports){
...
},{"./ReactElement":96,"_process":1,"fbjs/lib/invariant":190}],168:[function(require,module,exports){
...
},{"./ReactCurrentOwner":78,"./ReactElement":96,"./ReactInstanceHandles":105,"./getIteratorFn":161,"_process":1,"fbjs/lib/invariant":190,"fbjs/lib/warning":201}],174:[function(require,module,exports){
(function (process){
...
},{"./Object.assign":66,"_process":1,"fbjs/lib/emptyFunction":182,"fbjs/lib/warning":201}],175:[function(require,module,exports){
(function (process){
...
$(function(){require("./views/search"),require("./views/trips/index"),require("./views/trips/quick"),require("./views/reservations/pending"),require("./views/reservations/confirmed"),require("./views/reservations/unconfirmed"),require("./views/reservations/unpaid"),require("./views/calendar/entries")}),$(function(){function e(e,i,r){if($(i).is(":checked")){var n=$(e).show();r&&n.find("input").focus()}else $(e).hide()}require("./lib");$("#reservation_confirmed").on("change",function(i,r){e("#toggle_confirm",this,!r)}).triggerHandler("change",!0),$("#reservation_paid").on("change",function(i,r){e("#toggle_paid",this,!r)}).triggerHandler("change",!0),setTimeout(function(){$("#flash-notice").fadeOut()},5e3)});
},{"./lib":208,"./views/calendar/entries":209,"./views/reservations/confirmed":210,"./views/reservations/pending":211,"./views/reservations/unconfirmed":212,"./views/reservations/unpaid":213,"./views/search":214,"./views/trips/index":215,"./views/trips/quick":216}],204:[function(require,module,exports){
function onKeyDown(e){if(e.persist(),"Enter"===e.key){var t=$(e.target),a=t.closest("form"),r=lib.formInputs(a),i=r.index(t),s=e.ctrlKey||e.metaKey;if(!s&&"TEXTAREA"===t.prop("tagName"))return;if(e.preventDefault(),i===r.length-1||s){var l=a.find("[type=submit]");l.length?l.first().click():a.submit()}else r.eq(i+1).focus()}}var React=require("react"),_=require("lodash"),moment=require("moment"),chrono=require("chrono-node"),DatePicker=require("react-date-picker"),lib=require("../lib"),StaticField=React.createClass({displayName:"StaticField",render:function(){return React.createElement("div",{className:"form-group"},React.createElement("label",{className:"control-label"},this.props.title),React.createElement("p",{className:"form-control-static"},this.props.value))}}),TextField=React.createClass({displayName:"TextField",render:function(){return React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:this.props.id},this.props.title),React.createElement("input",{type:"text",className:"form-control",onKeyDown:onKeyDown,required:Boolean(this.props.required),defaultValue:this.props.defaultValue,valueLink:this.props.value,name:this.props.name,id:this.props.id}))}}),TextArea=React.createClass({displayName:"TextArea",render:function(){return React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:this.props.id},this.props.title),React.createElement("textarea",{className:"form-control",onKeyDown:onKeyDown,required:Boolean(this.props.required),defaultValue:this.props.defaultValue,valueLink:this.props.value,name:this.props.name,id:this.props.id}))}}),NumberField=React.createClass({displayName:"NumberField",render:function(){var e=_.pick(this.props,["min","max","step"]);return React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:this.props.id},this.props.title),React.createElement("input",React.__spread({type:"number",className:"form-control",onKeyDown:onKeyDown,placeholder:this.props.title,required:Boolean(this.props.required),defaultValue:this.props.defaultValue,valueLink:this.props.value},e,{name:this.props.name,id:this.props.id})))}}),SelectField=React.createClass({displayName:"SelectField",render:function(){var e=_(this.props.options).map(function(e){return"object"!=typeof e?{value:e,title:String(e)}:Array.isArray(e)?{value:e[0],title:e[1]||e[0]}:e}).map(function(e){return React.createElement("option",{key:e.value,value:e.value},e.title)}).value();return this.props.prompt&&e.unshift(React.createElement("option",{key:"prompt"},this.props.prompt)),React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:this.props.id},this.props.title),React.createElement("select",{className:"form-control",onKeyDown:onKeyDown,valueLink:this.props.value,id:this.props.id,name:this.props.name},e))}}),PaxField=React.createClass({displayName:"PaxField",statics:{ValidationRegExp:/^\d+(?:\/\d+){0,2}/,parsePax:function(e){var t=String(e).split("/").map(parseInt);return{total:t[0]||0,children:t[1]||0,disabled:t[2]||0}},reformat:function(e){var t=this.parsePax(e),a=String(t.total);return t.children&&(a+="/"+t.children),t.disabled&&(t.children||(a+="/0"),a+="/"+t.disabled),a}},render:function(){var e=_.pick(this.props,"onBlur onFocus onChange".split(" "));return React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:this.props.id},this.props.title),React.createElement("div",{className:"input-group"},React.createElement("div",{className:"input-group-addon"},React.createElement("i",{className:"glyphicon glyphicon-user"})),React.createElement("input",React.__spread({type:"text",className:"form-control"},e,{onKeyDown:onKeyDown,placeholder:"number of people",required:Boolean(this.props.required),valueLink:this.props.value,name:this.props.name,id:this.props.id}))))}}),DateTimeField=React.createClass({displayName:"DateTimeField",handleShowPicker:function(e){e.preventDefault();var t=this.validateValue(),a=moment(this.parseValue());this.setState({open:!this.state.open,date:a,valid:t})},handlePickDate:function(e,t){var a=this.state.date,r=moment(t).hour(a.hour()).minute(a.minute()).second(a.second()),i=this.props.noTime?"YYYY-MM-DD":"YYYY-MM-DD h:mm A",s=r.format(i);this.props.value.requestChange(s),this.setState({date:r,valid:!0}),this.hidePicker()},hidePicker:function(){this.setState({open:!1})},validateValue:function(){if(!this.props.value.value)return!0;var e=this.parseValue();return moment(e).isValid()},parseValue:function(){var e=this.props.value.value;return e?moment.utc(chrono.parseDate(e)):moment()},getInitialState:function(){var e=this.parseValue(),t=this.validateValue(),a=t?moment(e):moment().startOf("day");return{open:!1,valid:t,date:a}},render:function(){var e,t=_.pick(this.props,"onBlur onFocus onChange".split(" ")),a="form-group datetime-container",r="date and time";return this.props.noTime&&(r="date"),this.state.valid||(a+=" has-error"),this.state.open&&(e=React.createElement(DatePicker,{minDate:this.props.min,maxDate:this.props.max,date:this.state.date,onChange:this.handlePickDate,hideFooter:!0})),React.createElement("div",{className:a},React.createElement("label",{htmlFor:this.props.id},this.props.title),React.createElement("div",{className:"input-group"},React.createElement("input",React.__spread({type:"datetime",className:"form-control"},t,{placeholder:r,onKeyDown:onKeyDown,required:Boolean(this.props.required),valueLink:this.props.value,name:this.props.name,id:this.props.id})),React.createElement("div",{className:"datetime"},e),React.createElement("div",{className:"input-group-btn"},React.createElement("button",{className:"btn btn-default",tabIndex:"-1",onClick:this.handleShowPicker},React.createElement("i",{className:"glyphicon glyphicon-calendar"})))))}}),PriceField=React.createClass({displayName:"PriceField",render:function(){var e=_.pick(this.props,["min","max","step"]);e.min=e.min||0;var t=_.pick(this.props,"onBlur onFocus onChange".split(" "));return React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:this.props.id},this.props.title),React.createElement("div",{className:"input-group"},React.createElement("div",{className:"input-group-addon"},React.createElement("i",{className:"glyphicon glyphicon-usd"})),React.createElement("input",React.__spread({type:"number",className:"form-control"},t,{onKeyDown:onKeyDown,required:Boolean(this.props.required),defaultValue:this.props.defaultValue,valueLink:this.props.value},e,{name:this.props.name,id:this.props.id}))))}});module.exports={PaxField:PaxField,PriceField:PriceField,DateTimeField:DateTimeField,TextField:TextField,TextArea:TextArea,NumberField:NumberField,SelectField:SelectField,StaticField:StaticField};
},{"../lib":208,"chrono-node":2,"lodash":28,"moment":29,"react":202,"react-date-picker":36}],205:[function(require,module,exports){
var _=require("lodash"),Forms=require("./forms"),React=require("react"),moment=require("moment"),LinkedStateMixin=require("react-addons-linked-state-mixin");"undefined"==typeof window.COMPANIES&&(window.COMPANIES=[]);var toOption=function(e){return{value:e.company.id,title:e.company.name}},forKind=function(e){return function(t){return t.company.kind===e}},HOTELS=COMPANIES.filter(forKind("hotel")).map(toOption),TOURS=COMPANIES.filter(forKind("tour")).map(toOption),TRANSPORTS=COMPANIES.filter(forKind("transport")).map(toOption),Form=React.createClass({displayName:"Form",mixins:[LinkedStateMixin],getInitialState:function(e){e=e||this.props;var t,a,i=e.reservation,c=i?i.reservation:e.defaults||{};return t=_.compact([c.departure,c.departure_time]).join(" "),a=_.compact([c.arrival,c.arrival_time]).join(" "),_.assign({arrival_date_time:a,departure_date_time:t,dropoff_location:c.dropoff_location,pickup_location:c.pickup_location},c)},componentWillReceiveProps:function(e){this.setState(this.getInitialState(e))},setDefaultRackPrice:function(e){var t=Number(e.target.value);!this.state.price&&t&&this.setState({price:t})},render:function(){var e,t,a,i=this.props.method;switch(this.state.id&&(e=React.createElement("input",{type:"hidden",name:"reservation[id]",value:this.state.id})),i||(i=this.state.id?"put":"post"),a=this.props.kind[0].toUpperCase()+this.props.kind.substr(1),this.props.kind){case"hotel":t=HOTELS;break;case"tour":t=TOURS;break;case"transport":t=TRANSPORTS,a="Operator"}return React.createElement("div",{className:"row"},React.createElement("form",{className:"form",method:"post",action:this.props.action},React.createElement("input",{type:"hidden",name:"_method",value:i}),e,React.createElement("div",{className:"col-xs-12 col-sm-3"},React.createElement(Forms.PaxField,{id:"reservation-num_people",name:"reservation[num_people]",title:"Pax",required:!0,value:this.linkState("num_people")})),React.createElement("div",{className:"col-xs-12 col-sm-6"},React.createElement(Forms.TextField,{id:"reservation-services",name:"reservation[services]",title:"Services",value:this.linkState("services")})),React.createElement("div",{className:"col-xs-12 col-sm-3"},React.createElement(Forms.SelectField,{id:"reservation-company_id",name:"reservation[company_id]",title:a,prompt:"Select a Company",required:!0,value:this.linkState("company_id"),options:t})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.PriceField,{id:"reservation-net_price",name:"reservation[net_price]",title:"Net Price",onBlur:this.setDefaultRackPrice,value:this.linkState("net_price"),required:!0,min:0,step:.01})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.PriceField,{id:"reservation-price",name:"reservation[price]",title:"Rack Price",value:this.linkState("price"),required:!0,min:0,step:.01})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.DateTimeField,{id:"reservation-arrival_date_time",name:"reservation[arrival_date_time]",title:"Arrival",value:this.linkState("arrival_date_time"),required:!0})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.DateTimeField,{id:"reservation-departure_date_time",name:"reservation[departure_date_time]",title:"Departure",value:this.linkState("departure_date_time"),required:!0})),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.TextField,{id:"reservation-pickup",name:"reservation[pickup_location]",title:"Pick Up Location",value:this.linkState("pickup_location")})),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.TextField,{id:"reservation-dropoff",name:"reservation[dropoff_location]",title:"Drop Off Location",value:this.linkState("dropoff_location")})),React.createElement("div",{className:"col-xs-12 text-right"},React.createElement("button",{className:"btn btn-primary",type:"submit"},React.createElement("i",{className:"glyphicon glyphicon-ok"}),"  Save"))))}}),RackPrice=React.createClass({displayName:"RackPrice",mixins:[LinkedStateMixin],getInitialState:function(e){return e=e||this.props,_.assign({},e)},componentWillReceiveProps:function(e){this.setState(this.getInitialState(e))},render:function(){return React.createElement("form",{className:"form",action:this.props.action,method:"post"},React.createElement("input",{type:"hidden",name:"_method",value:"put"}),React.createElement("div",{className:"row"},React.createElement("div",{className:"col-xs-12 col-sm-6"},React.createElement(Forms.StaticField,{title:"Company",value:this.state.company})),React.createElement("div",{className:"col-xs-12 col-sm-6"},React.createElement(Forms.StaticField,{title:"Services",value:this.state.services}))),React.createElement("div",{className:"row"},React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.StaticField,{title:"Net Price",value:this.state.netPrice})),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.PriceField,{value:this.linkState("rackPrice"),id:"reservation-price",name:"reservation[price]",required:!0,title:"Rack Price"}))),React.createElement("div",{className:"row"},React.createElement("div",{className:"col-xs-12"},React.createElement(Forms.TextArea,{value:this.linkState("notes"),id:"reservation-notes",name:"reservation[notes]",title:"Private Notes"}))),React.createElement("div",{className:"row"},React.createElement("div",{className:"col-xs-12 text-right"},React.createElement("button",{type:"submit",className:"btn btn-primary"},React.createElement("i",{className:"glyphicon glyphicon-ok"}),"  Save"))))}}),Confirmation=React.createClass({displayName:"Confirmation",mixins:[LinkedStateMixin],getInitialState:function(e){return e=e||this.props,_.assign({},e)},componentWillReceiveProps:function(e){this.setState(this.getInitialState(e))},render:function(){return React.createElement("form",{className:"form",action:this.props.action,method:"post"},React.createElement("input",{type:"hidden",name:"_method",value:"put"}),React.createElement("input",{type:"hidden",name:"reservation[confirmed]",value:"true"}),React.createElement("div",{className:"row"},React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.StaticField,{title:"Company",value:this.state.company})),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.StaticField,{title:"Services",value:this.state.services})),React.createElement("div",{className:"col-xs-12"},React.createElement(Forms.TextField,{title:"Confirmation Number",value:this.linkState("confirmation"),name:"reservation[confirmation_no]",id:"reservation-confirmation_no"})),React.createElement("div",{className:"col-xs-12"},React.createElement(Forms.TextArea,{title:"Private Notes",value:this.linkState("notes"),name:"reservation[notes]",id:"reservation-notes"}))),React.createElement("div",{className:"row"},React.createElement("div",{className:"col-xs-12 text-right"},React.createElement("button",{type:"submit",className:"btn btn-primary"},React.createElement("i",{className:"glyphicon glyphicon-ok-circle"}),"  Confirm"))))}}),Payment=React.createClass({displayName:"Payment",mixins:[LinkedStateMixin],getInitialState:function(e){return e=e||this.props,_.assign({},e)},componentWillReceiveProps:function(e){this.setState(this.getInitialState(e))},render:function(){var e=moment();return React.createElement("form",{className:"form",action:this.props.action,method:"post"},React.createElement("input",{type:"hidden",name:"_method",value:"put"}),React.createElement("input",{type:"hidden",name:"reservation[paid]",value:"true"}),React.createElement("div",{className:"row"},React.createElement("div",{className:"col-xs-8 col-md-12"},React.createElement(Forms.StaticField,{title:"Company",value:this.state.company})),React.createElement("div",{className:"col-xs-4 col-md-6"},React.createElement(Forms.StaticField,{title:"Net Price",value:this.state.netPrice})),React.createElement("div",{className:"col-xs-12 col-md-6"},React.createElement(Forms.DateTimeField,{title:"Date of Payment",value:this.linkState("paidDate"),name:"reservation[paid_date]",max:e,noTime:!0,id:"reservation-paid_date"})),React.createElement("div",{className:"col-xs-12"},React.createElement(Forms.TextArea,{title:"Private Notes",value:this.linkState("notes"),name:"reservation[notes]",id:"reservation-notes"}))),React.createElement("div",{className:"row"},React.createElement("div",{className:"col-xs-12 text-right"},React.createElement("button",{type:"submit",className:"btn btn-primary"},React.createElement("i",{className:"glyphicon glyphicon-usd"}),"  Mark as Paid"))))}}),View=React.createClass({displayName:"View",mixins:[LinkedStateMixin],getInitialState:function(e){return e=e||this.props,_.assign({},e)},componentWillReceiveProps:function(e){this.setState(this.getInitialState(e))},render:function(){var e=this.state.reservation,t=this.state.company,a="dddd, MMMM D, YYYY",i=moment(e.arrival).format(a),c=moment(e.departure).format(a),r=[i,e.arrival_time].filter(Boolean).join(" - "),n=[c,e.departure_time].filter(Boolean).join(" - "),s=e.net_price?"$"+Number(e.net_price):"",l=e.price?"$"+Number(e.price):"";return React.createElement("div",{className:"row"},React.createElement("div",{className:"col-xs-4"},React.createElement(Forms.StaticField,{title:"Pax",value:e.num_people})),React.createElement("div",{className:"col-xs-8"},React.createElement(Forms.StaticField,{title:"Services",value:e.services})),React.createElement("div",{className:"col-xs-12"},React.createElement(Forms.StaticField,{title:"Company",value:t})),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.StaticField,{title:"Arrival",value:r})),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.StaticField,{title:"Pick Up",value:e.pickup_location})),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.StaticField,{title:"Departure",value:n})),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.StaticField,{title:"Drop Off",value:e.dropoff_location})),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.StaticField,{title:"Net Price",value:s})),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.StaticField,{title:"Rack Price",value:l})),React.createElement("div",{className:"col-xs-12"},React.createElement(Forms.StaticField,{title:"Private Notes",value:e.notes})),React.createElement("div",{className:"col-xs-12 text-right"},React.createElement("a",{href:this.state.tripUrl,className:"btn btn-primary"},React.createElement("i",{className:"glyphicon glyphicon-tag"}),"  Trip ",this.state.tripId)))}});module.exports={Form:Form,RackPrice:RackPrice,Confirmation:Confirmation,Payment:Payment,View:View};
},{"./forms":204,"lodash":28,"moment":29,"react":202,"react-addons-linked-state-mixin":30}],206:[function(require,module,exports){
var _=require("lodash"),React=require("react"),Search=React.createClass({displayName:"Search",getInitialState:function(){return{query:"",results:[],loading:!1}},handleQueryChange:function(e){var t=String(e.target.value).trim();t?(this.setState({query:t,loading:!0}),this.performSearch()):this.setState(this.getInitialState())},performSearch:_.debounce(function(){$.ajax({url:this.props.url,data:{q:this.state.query},success:function(e){this.isMounted()&&this.setState({loading:!1,results:e})}.bind(this)})},250),render:function(){var e=React.createElement(SearchResults,{data:this.state.results,loading:this.state.loading});return React.createElement("form",{action:this.props.url,onSubmit:function(e){e.preventDefault()}},React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:"search-query",className:"sr-only"},"Search"),React.createElement("input",{type:"search",name:"q",value:this.state.query,onChange:this.handleQueryChange,id:"search-query",className:"form-control",autoComplete:"off",placeholder:"name, email, or phone"})),this.state.query.length?e:"")}}),SearchResults=React.createClass({displayName:"SearchResults",render:function(){if(this.props.loading)return React.createElement(SearchLoading,null);if(this.props.data.length){var e=_.map(this.props.data,function(e,t){return React.createElement(SearchResult,{key:t,url:e.url,name:e.name,phone:e.phone,email:e.email})});return React.createElement("table",{className:"table table-striped"},React.createElement("tbody",null,e))}return React.createElement(SearchNoResults,null)}}),SearchResult=React.createClass({displayName:"SearchResult",render:function(){var e,t,a,r;return this.props.email&&(t=String(this.props.email).toLowerCase().trim().replace(/^\W*|\W*$/,""),e=React.createElement("span",null,React.createElement("i",{className:"glyphicon glyphicon-envelope"})," ",React.createElement("a",{href:"mailto:"+t},t))),this.props.phone&&(r=String(this.props.phone).trim().replace(/\D/g,""),a=React.createElement("span",null,React.createElement("i",{className:"glyphicon glyphicon-phone"})," ",React.createElement("a",{href:"tel:"+r},this.props.phone))),React.createElement("tr",null,React.createElement("td",{className:"col-xs-6"},React.createElement("i",{className:"glyphicon glyphicon-user"})," ",React.createElement("a",{href:this.props.url},this.props.name)),React.createElement("td",{className:"col-xs-3 force-wrap"},e),React.createElement("td",{className:"col-xs-3"},a))}}),SearchNoResults=React.createClass({displayName:"SearchNoResults",render:function(){return React.createElement("div",{className:"alert alert-danger"},React.createElement("strong",null,React.createElement("i",{className:"glyphicon glyphicon-remove"}),"  No results"),"  Sorry, nothing was found matching your search criteria.")}}),SearchLoading=React.createClass({displayName:"SearchLoading",render:function(){return React.createElement("div",{className:"alert alert-info"},React.createElement("strong",null,React.createElement("i",{className:"glyphicon glyphicon-refresh spin"}),"  Loading..."),"  Please wait while we query the server.")}});module.exports=Search;
},{"lodash":28,"react":202}],207:[function(require,module,exports){
var React=require("react"),Forms=require("./forms"),LinkedStateMixin=require("react-addons-linked-state-mixin"),_=require("lodash"),moment=require("moment"),chrono=require("chrono-node"),QuickForm=React.createClass({mixins:[LinkedStateMixin],displayName:"QuickForm",getInitialState:function(e){e=e||this.props;var t,a=e.trip,i=a?_.assign({},a.trip):{};return i.arrival&&(t=moment.utc(chrono.parseDate(i.arrival)),t.isValid()&&(i.arrival=t.format("YYYY-MM-DD h:mm A"))),i.departure&&(t=moment.utc(chrono.parseDate(i.departure)),t.isValid()&&(i.departure=t.format("YYYY-MM-DD h:mm A"))),i},componentWillReceiveProps:function(e){this.setState(this.getInitialState(e))},render:function(){var e,t="post";return this.state.id&&(t="put"),this.props.onCancel&&(e=React.createElement("button",{className:"btn btn-default",onClick:this.props.onCancel},React.createElement("i",{className:"glyphicon glyphicon-remove"}),"  Cancel")),React.createElement("div",{className:"row"},React.createElement("form",{action:this.props.action,method:"post",className:"form"},React.createElement("input",{type:"hidden",name:"_method",value:t}),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.PaxField,{id:"trip-total_people",name:"trip[total_people]",title:"Total People",required:!0,value:this.linkState("total_people")})),React.createElement("div",{className:"col-xs-6"},React.createElement(Forms.PaxField,{id:"trip-num_children",name:"trip[num_children]",title:"Children",value:this.linkState("num_children")})),React.createElement("div",{className:"col-xs-6 col-sm-4"},React.createElement(Forms.DateTimeField,{id:"trip-arrival",name:"trip[arrival]",title:"Arrival",required:!0,value:this.linkState("arrival")})),React.createElement("div",{className:"col-xs-6 col-sm-8"},React.createElement(Forms.TextField,{id:"trip-arrival_flight",name:"trip[arrival_flight]",title:"Location / Flight",value:this.linkState("arrival_flight")})),React.createElement("div",{className:"col-xs-6 col-sm-4"},React.createElement(Forms.DateTimeField,{id:"trip-departure",name:"trip[departure]",title:"Departure",required:!0,value:this.linkState("departure")})),React.createElement("div",{className:"col-xs-6 col-sm-8"},React.createElement(Forms.TextField,{id:"trip-departure_flight",name:"trip[departure_flight]",title:"Location / Flight",value:this.linkState("departure_flight")})),React.createElement("div",{className:"col-xs-12 text-right"},React.createElement("div",{className:"btn-group"},React.createElement("button",{className:"btn btn-primary",type:"submit"},React.createElement("i",{className:"glyphicon glyphicon-ok"}),"  Save"),e))))}}),SupplementalPrice=React.createClass({displayName:"SupplementalPrice",mixins:[LinkedStateMixin],getInitialState:function(e){return e=e||this.props,_.assign({},e)},componentWillReceiveProps:function(e){this.setState(this.getInitialState(e))},render:function(){return React.createElement("form",{className:"form",method:"post",action:this.props.action},React.createElement("input",{type:"hidden",name:"_method",value:"put"}),React.createElement("div",{className:"row"},React.createElement("div",{className:"col-xs-4"},React.createElement(Forms.StaticField,{title:"Total Net Price",value:this.state.totalNet})),React.createElement("div",{className:"col-xs-4"},React.createElement(Forms.StaticField,{title:"Total Rack Price",value:this.state.totalRack})),React.createElement("div",{className:"col-xs-4"},React.createElement(Forms.PriceField,{title:"Supplemental Rack Price",id:"trip-supplemental_price",name:"trip[supplemental_price]",require:!0,value:this.linkState("price")}))),React.createElement("div",{className:"row"},React.createElement("div",{className:"col-xs-12 text-right"},React.createElement("button",{type:"submit",className:"btn btn-primary"},React.createElement("i",{className:"glyphicon glyphicon-ok"}),"  Save"))))}});module.exports={QuickForm:QuickForm,SupplementalPrice:SupplementalPrice};
},{"./forms":204,"chrono-node":2,"lodash":28,"moment":29,"react":202,"react-addons-linked-state-mixin":30}],208:[function(require,module,exports){
var lib={formInputs:function(t){var n=$(t),e=[":button",":reset",":submit",":disabled",'[type="hidden"]'],u=e.map(function(t){return":not("+t+")"}).join("");return n.find(":input"+u)},guessInput:function(t){var n=$(t).filter(function(){return""===this.value});return 0===n.length&&(n=n.end()),n.first()},selectInput:function(t){var n=$(t);""===n.val()?n.focus():n.select()},selectFormInput:function(t){var n=lib.formInputs(t),e=lib.guessInput(n);lib.selectInput(e)}};module.exports=lib;
},{}],209:[function(require,module,exports){
var React=require("react"),ReactDOM=require("react-dom"),components=require("components"),lib=require("../../lib"),$reservation=$(".calendar-reservation"),$reservationModal=$("#calendar-modal"),$reservationMount=$reservationModal.find(".react-mount");$reservation.on("click",function(e){e.preventDefault();var r=$(this),a=r.data("company"),t=r.data("trip-url"),n=r.data("trip-id"),o=r.data("reservation").reservation;ReactDOM.render(React.createElement(components.Reservations.View,{reservation:o,company:a,tripUrl:t,tripId:n}),$reservationMount.get(0),function(){$reservationModal.modal("show")})});
},{"../../lib":208,"components":"components","react":202,"react-dom":43}],210:[function(require,module,exports){
var React=require("react"),ReactDOM=require("react-dom"),components=require("components"),chrono=require("chrono-node"),moment=require("moment"),lib=require("../../lib"),$rackPrice=$(".edit-rack-price"),$supplementalPrice=$(".edit-supplemental-price"),$priceModal=$("#edit-price-modal"),$priceMount=$priceModal.find(".react-mount");$rackPrice.on("click",function(){var e=$(this),t=e.data("net-price"),a=Number(e.data("rack-price")),c=e.data("services"),r=e.data("company"),i=e.data("notes"),o=e.data("action");ReactDOM.render(React.createElement(components.Reservations.RackPrice,{action:o,company:r,services:c,netPrice:t,rackPrice:a,notes:i}),$priceMount.get(0),function(){$priceModal.modal("show")})}),$supplementalPrice.on("click",function(){var e=$(this),t=Number(e.data("price")),a=e.data("total-net"),c=e.data("total-rack"),r=e.data("action");ReactDOM.render(React.createElement(components.Trips.SupplementalPrice,{action:r,totalNet:a,totalRack:c,price:t}),$priceMount.get(0),function(){$priceModal.modal("show")})}),$priceModal.on("shown.bs.modal",function(){lib.selectFormInput(this)});
},{"../../lib":208,"chrono-node":2,"components":"components","moment":29,"react":202,"react-dom":43}],211:[function(require,module,exports){
var React=require("react"),ReactDOM=require("react-dom"),components=require("components"),chrono=require("chrono-node"),moment=require("moment"),lib=require("../../lib"),$pasteReservations=$("#paste-reservations"),$pasteModal=$("#paste-reservations-modal");$pasteReservations.on("click",function(e){e.preventDefault(),$pasteModal.modal("show")});var $addReservation=$("#add-reservation"),transferring=!1;$addReservation.find('a[data-toggle="tab"]').on("show.bs.tab",function(e){if(transferring)return void(transferring=!1);var t=$(this).attr("href"),r=$addReservation.data("action-url"),a=$(t).find(".react-mount").get(0),n="undefined"==typeof window.DEFAULTS?{}:window.DEFAULTS;delete window.DEFAULTS,TRIP.total_people&&!n.num_people&&(n.num_people=TRIP.total_people),ReactDOM.render(React.createElement(components.Reservations.Form,{kind:t.replace("#",""),action:r,defaults:n}),a)}).on("shown.bs.tab",function(e){var t=$(this).attr("href");lib.selectFormInput(t)});var $bookTransferIn=$("#book-transfer-in"),$bookTransferOut=$("#book-transfer-out"),$transferTab=$addReservation.find('a[href="#transport"]');$bookTransferIn.add($bookTransferOut).on("click",function(e){var t,r={};e.preventDefault(),TRIP&&(r.num_people=TRIP.total_people,this.id===$bookTransferIn.attr("id")?(t=moment.utc(chrono.parseDate(TRIP.arrival)),t.isValid()&&(r.arrival_date_time=t.format("YYYY-MM-DD h:mm A")),TRIP.arrival_flight&&(r.pickup_location=TRIP.arrival_flight)):(t=moment.utc(chrono.parseDate(TRIP.departure)),t.isValid()&&(r.departure_date_time=t.format("YYYY-MM-DD h:mm A")),TRIP.departure_flight&&(r.dropoff_location=TRIP.departure_flight))),transferring=!0,ReactDOM.render(React.createElement(components.Reservations.Form,{kind:"transport",action:$addReservation.data("action-url"),defaults:r}),$addReservation.find("#transport .react-mount").get(0),function(){$transferTab.tab("show")})});var $quickTrip=$("#quick-trip"),$quickTripView=$("#trip-quick-details"),$showQuickTrip=$("#show-quick-trip-form");$showQuickTrip.on("click",function(e){function t(e){e.preventDefault(),$quickTrip.slideUp(function(){$quickTripView.slideDown()})}e.preventDefault(),$quickTrip.hide(),$quickTripView.slideUp(function(){ReactDOM.render(React.createElement(components.Trips.QuickForm,{trip:$quickTrip.data("trip"),action:$quickTrip.data("action"),onCancel:t}),$quickTrip.get(0),function(){$quickTrip.slideDown()})})});var $editReservation=$(".edit-reservation"),$reservationModal=$("#edit-reservation-modal"),$reservationMount=$reservationModal.find(".react-mount");$editReservation.on("click",function(e){e.preventDefault();var t=$(this),r=t.data("kind"),a=t.data("action"),n="put",o=t.data("reservation")||{};ReactDOM.render(React.createElement(components.Reservations.Form,{kind:r,action:a,method:n,reservation:o}),$reservationMount.get(0),function(){$reservationModal.modal("show")})}),$reservationModal.on("shown.bs.modal",function(){lib.selectFormInput($reservationMount.find("form"))}),window.DEFAULTS?DEFAULTS.id?$("#edit-reservation-"+DEFAULTS.id).click():$('a[href="#'+DEFAULTS.kind+'"]').tab("show"):window.KIND&&$('a[href="#'+KIND+'"]').tab("show");
},{"../../lib":208,"chrono-node":2,"components":"components","moment":29,"react":202,"react-dom":43}],212:[function(require,module,exports){
var React=require("react"),ReactDOM=require("react-dom"),components=require("components"),chrono=require("chrono-node"),moment=require("moment"),lib=require("../../lib"),$confirmRes=$(".confirm-reservation"),$confirmModal=$("#confirm-reservation-modal"),$confirmMount=$confirmModal.find(".react-mount");$confirmRes.on("click",function(){var o=$(this),n=o.data("confirmation"),e=o.data("notes"),r=o.data("services"),t=o.data("company"),i=o.data("action");ReactDOM.render(React.createElement(components.Reservations.Confirmation,{action:i,company:t,services:r,confirmation:n,notes:e}),$confirmMount.get(0),function(){$confirmModal.modal("show")})}),$confirmModal.on("shown.bs.modal",function(){lib.selectFormInput(this)});
},{"../../lib":208,"chrono-node":2,"components":"components","moment":29,"react":202,"react-dom":43}],213:[function(require,module,exports){
var React=require("react"),ReactDOM=require("react-dom"),components=require("components"),chrono=require("chrono-node"),moment=require("moment"),lib=require("../../lib"),$payRes=$(".pay-reservation"),$payModal=$("#pay-reservation-modal"),$payMount=$payModal.find(".react-mount");$payRes.on("click",function(){var e=$(this),a=e.data("paid-date"),t=e.data("net-price"),o=e.data("notes"),n=e.data("company"),r=e.data("action");ReactDOM.render(React.createElement(components.Reservations.Payment,{action:r,company:n,paidDate:a,netPrice:t,notes:o}),$payMount.get(0),function(){$payModal.modal("show")})}),$payModal.on("shown.bs.modal",function(){lib.selectFormInput(this)});
},{"../../lib":208,"chrono-node":2,"components":"components","moment":29,"react":202,"react-dom":43}],214:[function(require,module,exports){
var React=require("react"),ReactDOM=require("react-dom"),components=require("components"),lib=require("../lib"),$searchClients=$("#search-clients"),$searchModal=$("#search-modal"),$searchMount=$searchModal.find(".react-mount"),searchUrl=$searchClients.attr("href");$searchClients.on("click",function(e){e.preventDefault(),ReactDOM.render(React.createElement(components.Search,{url:searchUrl}),$searchMount.get(0),function(){$searchModal.modal("show")})}),$searchModal.on("shown.bs.modal",function(){lib.selectFormInput($searchModal)});
},{"../lib":208,"components":"components","react":202,"react-dom":43}],215:[function(require,module,exports){
var React=require("react"),ReactDOM=require("react-dom"),components=require("components"),lib=require("../../lib"),$editTrip=$(".edit-trip"),$tripModal=$("#edit-trip-modal"),$tripMount=$tripModal.find(".react-mount");$editTrip.on("click",function(t){t.preventDefault();var i=$(this),e=i.data("action"),r=i.data("trip")||{};ReactDOM.render(React.createElement(components.Trips.QuickForm,{action:e,trip:r}),$tripMount.get(0),function(){$tripModal.modal("show")})}),$tripModal.on("shown.bs.modal",function(){lib.selectFormInput($tripMount.find("form"))});
},{"../../lib":208,"components":"components","react":202,"react-dom":43}],216:[function(require,module,exports){
var React=require("react"),ReactDOM=require("react-dom"),components=require("components"),$quickTrip=$("#quick-trip");$quickTrip.data("active")&&ReactDOM.render(React.createElement(components.Trips.QuickForm,{trip:$quickTrip.data("trip"),action:$quickTrip.data("action")}),$quickTrip.get(0));
},{"components":"components","react":202,"react-dom":43}],"components":[function(require,module,exports){
module.exports={Search:require("./search"),Forms:require("./forms"),Reservations:require("./reservations"),Trips:require("./trips")};
},{"./forms":204,"./reservations":205,"./search":206,"./trips":207}]},{},[203])


//# sourceMappingURL=application.map.json