...
$(function(){require("./views/search"),require("./views/trips/index"),require("./views/trips/quick"),require("./views/reservations/pending"),require("./views/reservations/confirmed"),require("./views/reservations/unconfirmed"),require("./views/reservations/unpaid")}),$(function(){function e(e,i,r){if($(i).is(":checked")){var n=$(e).show();r&&n.find("input").focus()}else $(e).hide()}require("./lib");$("#reservation_confirmed").on("change",function(i,r){e("#toggle_confirm",this,!r)}).triggerHandler("change",!0),$("#reservation_paid").on("change",function(i,r){e("#toggle_paid",this,!r)}).triggerHandler("change",!0),setTimeout(function(){$("#flash-notice").fadeOut()},5e3)});
},{"./lib":208,"./views/reservations/confirmed":209,"./views/reservations/pending":210,"./views/reservations/unconfirmed":211,"./views/reservations/unpaid":212,"./views/search":213,"./views/trips/index":214,"./views/trips/quick":215}],204:[function(require,module,exports){
...
},{"../../lib":208,"chrono-node":2,"components":"components","moment":29,"react":202,"react-dom":43}],210:[function(require,module,exports){
...
var React=require("react"),ReactDOM=require("react-dom"),components=require("components"),$mountSearch=$("#mount-search"),searchUrl=$mountSearch.data("url");ReactDOM.render(React.createElement(components.Search,{url:searchUrl}),$mountSearch.get(0));
},{"components":"components","react":202,"react-dom":43}],214:[function(require,module,exports){
...
var React=require("react"),ReactDOM=require("react-dom"),components=require("components"),$quickTrip=$("#quick-trip");"true"===String($quickTrip.data("active"))&&ReactDOM.render(React.createElement(components.Trips.QuickForm,{trip:$quickTrip.data("trip"),action:$quickTrip.data("action")}),$quickTrip.get(0));
