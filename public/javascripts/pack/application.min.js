...
var _=require("lodash"),React=require("react"),Search=React.createClass({displayName:"Search",getInitialState:function(){return{query:"",results:[],loading:!1}},handleQueryChange:function(e){var t=String(e.target.value).trim();t?(this.setState({query:t,loading:!0}),this.performSearch()):this.setState(this.getInitialState())},performSearch:_.debounce(function(){$.ajax({url:this.props.url,data:{q:this.state.query},success:function(e){this.isMounted()&&this.setState({loading:!1,results:e})}.bind(this)})}),render:function(){console.log("Search",this.state);var e=React.createElement(SearchResults,{data:this.state.results,loading:this.state.loading});return React.createElement("form",{action:this.props.url,onSubmit:function(e){e.preventDefault()}},React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:"search-query",className:"sr-only"},"Search"),React.createElement("input",{type:"search",name:"q",value:this.state.query,onChange:this.handleQueryChange,id:"search-query",className:"form-control",autoComplete:"off",placeholder:"name, email, or phone"})),this.state.query.length?e:"")}}),SearchResults=React.createClass({displayName:"SearchResults",render:function(){if(this.props.loading)return React.createElement(SearchLoading,null);if(this.props.data.length){var e=_.map(this.props.data,function(e,t){return React.createElement(SearchResult,{key:t,url:e.url,name:e.name,phone:e.phone,email:e.email})});return React.createElement("table",{className:"table table-striped"},e)}return React.createElement(SearchNoResults,null)}}),SearchResult=React.createClass({displayName:"SearchResult",render:function(){var e,t,a,r;return this.props.email&&(t=String(this.props.email).toLowerCase().trim().replace(/^\W*|\W*$/,""),e=React.createElement("span",null,React.createElement("i",{className:"glyphicon glyphicon-envelope"})," ",React.createElement("a",{href:"mailto:"+t},t))),this.props.phone&&(r=String(this.props.phone).trim().replace(/\D/g,""),a=React.createElement("span",null,React.createElement("i",{className:"glyphicon glyphicon-phone"})," ",React.createElement("a",{href:"tel:"+r},this.props.phone))),React.createElement("tr",null,React.createElement("td",null,React.createElement("i",{className:"glyphicon glyphicon-user"})," ",React.createElement("a",{href:this.props.url},this.props.name)),React.createElement("td",null,e),React.createElement("td",null,a))}}),SearchNoResults=React.createClass({displayName:"SearchNoResults",render:function(){return React.createElement("div",{className:"alert alert-danger"},React.createElement("strong",null,React.createElement("i",{className:"glyphicon glyphicon-remove"}),"  No results"),"  Sorry, nothing was found matching your search criteria.")}}),SearchLoading=React.createClass({displayName:"SearchLoading",render:function(){return React.createElement("div",{className:"alert alert-info"},React.createElement("strong",null,React.createElement("i",{className:"glyphicon glyphicon-refresh spin"}),"  Loading..."),"  Please wait while we query the server.")}});module.exports=Search;
