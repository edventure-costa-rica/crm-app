...
var _=require("lodash"),Forms=require("./forms"),toOption=function(e){return{value:e.company.id,title:e.company.name}},forKind=function(e){return function(t){return t.company.kind===e}},HOTELS=COMPANIES.filter(forKind("hotel")).map(toOption),TOURS=COMPANIES.filter(forKind("tour")).map(toOption),TRANSPORTS=COMPANIES.filter(forKind("transport")).map(toOption),Hotel=React.createClass({displayName:"Hotel",mixins:[React.addons.LinkedStateMixin],getInitialState:function(){var e,t,a=this.props.reservation,r=this.props.defaults||{};return a?(t=[new Date(a.departure).toDateString(),a.departure_time,a.dropoff_location].filter(Boolean).join(" "),e=[new Date(a.arrival).toDateString(),a.arrival_time,a.pickup_location].filter(Boolean).join(" "),_.assign({pick_up:e,drop_off:t},a)):{num_people:r.num_people,arrival:r.arrival,arrival_time:r.arrival_time,dropoff_location:r.dropoff_location,departure:r.departure,departure_time:r.departure_time,pickup_location:r.pickup_location}},setDefaultRackPrice:function(e){var t=Number(e.target.value);!this.state.price&&t&&this.setState({price:t})},render:function(){var e;return this.state.id&&(e=React.createElement("input",{type:"hidden",name:"reservation[id]",value:this.state.id})),React.createElement("div",{className:"row"},React.createElement("form",{className:"form",method:"post",action:this.props.action},e,React.createElement("div",{className:"col-xs-12 col-sm-3"},React.createElement(Forms.PaxField,{id:"reservation-pax",name:"reservation[pax]",title:"Pax",required:!0,value:this.linkState("num_people")})),React.createElement("div",{className:"col-xs-12 col-sm-6"},React.createElement(Forms.TextField,{id:"reservation-services",name:"reservation[services]",title:"Services",value:this.linkState("services")})),React.createElement("div",{className:"col-xs-12 col-sm-3"},React.createElement(Forms.SelectField,{id:"reservation-company_id",name:"reservation[company_id]",title:"Hotel",prompt:"Select a Company",required:!0,value:this.linkState("company_id"),options:HOTELS})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.PriceField,{id:"reservation-net_price",name:"reservation[net_price]",title:"Net Price",onBlur:this.setDefaultRackPrice,value:this.linkState("net_price"),required:!0,min:0,step:.01})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.PriceField,{id:"reservation-price",name:"reservation[price]",title:"Rack Price",value:this.linkState("price"),required:!0,min:0,step:.01})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.TransferField,{id:"reservation-pick_up",name:"reservation[pick_up]",title:"Pick Up",value:this.linkState("pickUp"),required:!0})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.TransferField,{id:"reservation-drop_off",name:"reservation[drop_off]",title:"Drop Off",value:this.linkState("dropOff"),required:!0})),React.createElement("div",{className:"col-xs-12 text-right"},React.createElement("button",{className:"btn btn-primary",type:"submit"},React.createElement("i",{className:"glyphicon glyphicon-ok"}),"  Save"))))}});module.exports={Hotel:Hotel};
