...
var _=require("lodash"),TextField=React.createClass({displayName:"TextField",render:function(){return React.createElement("div",{className:"form-group"},React.createElement("label",{"for":this.props.id},this.props.title),React.createElement("input",{type:"text",className:"form-control",required:Boolean(this.props.required),defaultValue:this.props.defaultValue,valueLink:this.props.value,name:this.props.name,id:this.props.id}))}}),NumberField=React.createClass({displayName:"NumberField",render:function(){var e=_.pick(this.props,["min","max","step"]);return React.createElement("div",{className:"form-group"},React.createElement("label",{"for":this.props.id},this.props.title),React.createElement("input",React.__spread({type:"number",className:"form-control",placeholder:this.props.title,required:Boolean(this.props.required),defaultValue:this.props.defaultValue,valueLink:this.props.value},e,{name:this.props.name,id:this.props.id})))}}),SelectField=React.createClass({displayName:"SelectField",render:function(){var e=_(this.props.options).map(function(e){return"object"!=typeof e?{value:e,title:String(e)}:Array.isArray(e)?{value:e[0],title:e[1]||e[0]}:e}).map(function(e){return React.createElement("option",{value:e.value},e.title)}).value();return this.props.prompt&&e.unshift(React.createElement("option",null,this.props.prompt)),React.createElement("div",{className:"form-group"},React.createElement("label",{"for":this.props.id},this.props.title),React.createElement("select",{className:"form-control",valueLink:this.props.value,id:this.props.id,name:this.props.name},e))}}),PaxField=React.createClass({displayName:"PaxField",statics:{ValidationRegExp:/^\d+(?:\/\d+){0,2}/,parsePax:function(e){var t=String(e).split("/").map(parseInt);return{total:t[0]||0,children:t[1]||0,disabled:parsts[2]||0}},reformat:function(e){var t=this.parsePax(e),a=String(t.total);return t.children&&(a+="/"+t.children),t.disabled&&(t.children||(a+="/0"),a+="/"+t.disabled),a}},render:function(){return React.createElement("div",{className:"form-group"},React.createElement("label",{"for":this.props.id},this.props.title),React.createElement("div",{className:"input-group"},React.createElement("div",{className:"input-group-addon"},React.createElement("i",{className:"glyphicon glyphicon-user"})),React.createElement("input",{type:"text",className:"form-control",placeholder:"pax/children/disabled",required:Boolean(this.props.required),valueLink:this.props.value,name:this.props.name,id:this.props.id})))}}),TransferField=React.createClass({displayName:"TransferField",render:function(){return React.createElement("div",{className:"form-group"},React.createElement("label",{"for":this.props.id},this.props.title),React.createElement("div",{className:"input-group"},React.createElement("div",{className:"input-group-addon"},React.createElement("i",{className:"glyphicon glyphicon-transfer"})),React.createElement("input",{type:"text",className:"form-control",placeholder:"date, time, and location",required:Boolean(this.props.required),valueLink:this.props.value,name:this.props.name,id:this.props.id})))}}),PriceField=React.createClass({displayName:"PriceField",render:function(){var e=_.pick(this.props,["min","max","step"]);return e.min=e.min||0,React.createElement("div",{className:"form-group"},React.createElement("label",{"for":this.props.id},this.props.title),React.createElement("div",{className:"input-group"},React.createElement("div",{className:"input-group-addon"},React.createElement("i",{className:"glyphicon glyphicon-usd"})),React.createElement("input",React.__spread({type:"number",className:"form-control",required:Boolean(this.props.required),defaultValue:this.props.defaultValue,valueLink:this.props.value},e,{name:this.props.name,id:this.props.id}))))}});module.exports={PaxField:PaxField,TransferField:TransferField,TextField:TextField,NumberField:NumberField,SelectField:SelectField};
...
var _=require("lodash"),Forms=require("./forms"),toOption=function(e){return{value:e.company.id,title:e.company.name}},forKind=function(e){return function(t){return t.company.kind===e}},HOTELS=COMPANIES.filter(forKind("hotel")).map(toOption),TOURS=COMPANIES.filter(forKind("tour")).map(toOption),TRANSPORTS=COMPANIES.filter(forKind("transport")).map(toOption),Hotel=React.createClass({displayName:"Hotel",mixins:[LinkedStateMixin],getInitialState:function(){var e,t,a=this.props.reservation,r=this.props.defaults||{};return a?(t=[new Date(a.departure).toDateString(),a.departure_time,a.dropoff_location].filter(Boolean).join(" "),e=[new Date(a.arrival).toDateString(),a.arrival_time,a.pickup_location].filter(Boolean).join(" "),_.assign({pick_up:e,drop_off:t},a)):{num_people:r.num_people,arrival:r.arrival,arrival_time:r.arrival_time,dropoff_location:r.dropoff_location,departure:r.departure,departure_time:r.departure_time,pickup_location:r.pickup_location}},setDefaultRackPrice:function(e){var t=Number(e.target.value);this.state.price||this.setState({price:t})},render:function(){var e,t=this.state.net_price;return this.state.id&&(e=React.createElement("input",{type:"hidden",name:"reservation[id]",value:this.state.id})),React.createElement("div",{className:"row"},React.createElement("form",{className:"form",method:"post",action:this.props.action},e,React.createElement("div",{className:"col-xs-3 col-sm-2"},React.createElement(Forms.PaxField,{id:"reservation-pax",name:"reservation[pax]",title:"Pax",required:!0,value:this.linkState("num_people")})),React.createElement("div",{className:"col-xs-6 col-sm-6"},React.createElement(Forms.TextField,{id:"reservation-services",name:"reservation[services]",title:"Services",value:this.linkState("services")})),React.createElement("div",{className:"col-xs-3 col-sm-4"},React.createElement(Forms.SelectField,{id:"reservation-company_id",name:"reservation[company_id]",title:"Hotel",prompt:"Select a Company",required:!0,value:this.linkState("company_id"),options:HOTELS})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.NumberField,{id:"reservation-net_price",name:"reservation[net_price]",title:"Net Price",onBlur:this.setDefaultRackPrice,value:this.linkState("net_price"),required:!0,min:0,step:.01})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.NumberField,{id:"reservation-price",name:"reservation[price]",title:"Rack Price",defaultValue:t,value:this.linkState("price"),required:!0,min:0,step:.01})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.TransferField,{id:"reservation-pick_up",name:"reservation[pick_up]",title:"Pick Up",value:this.linkState("pickUp"),required:!0})),React.createElement("div",{className:"col-xs-6 col-sm-3"},React.createElement(Forms.TransferField,{id:"reservation-drop_off",name:"reservation[drop_off]",title:"Drop Off",value:this.linkState("dropOff"),required:!0}))))}});module.exports={Hotel:Hotel};
